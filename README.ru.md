...
Эта же команда обновляет существующую установку. Перед заменой файлов установщик создаёт резервную копию в каталоге `/root/wifi-monitor-backups/` с датой и временем в имени.
