...
*На иллюстрациях показан английский интерфейс; имена устройств, SSID, IP и MAC заменены вымышленными данными. Показан фрагмент общего списка; счётчик относится ко всем подключениям.*
